    ...
    <div className="mx-auto max-w-4xl space-y-10 px-6 py-12">
      ...
      <section className="space-y-6">
        {sections.map((section) => (
          ...
          >
            ...
            <p className="mt-3 whitespace-pre-line text-sm text-muted">{section.body}</p>
          </article>
        ))}
      </section>
      ...
      <section className="rounded-3xl border border-border bg-card p-6 text-sm shadow-sm">
        ...
        <p className="mt-2 text-muted">
          Adoption contracts, medical records, and AKC paperwork are compiled in a secure client
          portal before go-home day. Custom requests (co-ownership, guardian homes, or show
          prospects) are reviewed on a case-by-case basis.
        </p>
      </section>
    </div>
  );
