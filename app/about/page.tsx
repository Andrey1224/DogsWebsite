  ...
  return (
    <div className="mx-auto max-w-4xl space-y-12 px-6 py-12">
      <header className="space-y-3">
        <p className="text-sm font-semibold uppercase tracking-[0.35em] text-emerald-600">About</p>
      ...
      <section className="grid gap-6 sm:grid-cols-3">
        {pillars.map((pillar) => (
          ...
          >
            ...
            <p className="mt-3 text-sm text-neutral-600 dark:text-neutral-300">{pillar.description}</p>
          </article>
        ))}
      </section>

      <section className="grid gap-6 rounded-3xl border border-neutral-200 bg-white/80 p-6 dark:border-neutral-800 dark:bg-neutral-900/80 sm:grid-cols-2">
        <div className="space-y-3">
          <h2 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100">Our facility</h2>
          <p className="text-sm text-neutral-600 dark:text-neutral-300">
        ...
        <div className="space-y-3">
          <h2 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100">Veterinary partners</h2>
          <p className="text-sm text-neutral-600 dark:text-neutral-300">
      ...
      <section className="rounded-3xl border border-neutral-200 bg-emerald-50/70 p-6 text-sm text-emerald-900 dark:border-emerald-900 dark:bg-emerald-950/40 dark:text-emerald-200">
        <p className="font-semibold">Schedule a kennel visit</p>
        <p className="mt-2">
