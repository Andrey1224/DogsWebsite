...
// [ВАЖНО ДЛЯ NEXT.JS]
// В вашем реальном проекте раскомментируйте строку ниже и удалите временный компонент Link:
// import Link from 'next/link';

// [ВРЕМЕННЫЙ КОМПОНЕНТ]
// Удалите этот блок кода в вашем проекте.
...
export default function NotFound() {
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[#0d1a44] px-4 font-[family-name:var(--font-geist-sans)] text-white selection:bg-[#ffb84d] selection:text-[#0d1a44]">
      {/* Decorative Background Elements (Paw Prints) */}
      ...
      <div className="relative z-10 mx-auto max-w-2xl text-center">
        {/* Animated 404 Text WITH PINK GRADIENT */}
